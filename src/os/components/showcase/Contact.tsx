...
const Contact: React.FC<ContactProps> = (props) => {
    ...
    async function submitForm() {
        ...
        const subject = encodeURIComponent(
            `${name}${company ? ` from ${company}` : ''} via portfolio`
        );
        ...
        window.location.href = `mailto:nijianweijerry@gmail.com?subject=${subject}&body=${body}`;
        setFormMessage(`Opening your email client. Thank you ${name}!`);
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    ...
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/jianwei-ni-984134139/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://github.com/JerryNee'}
            ...
            <div className="text-block">
                <p>
                    I am always happy to talk about mixed reality, generative
                    AI, medical training, research collaborations, and ambitious
                    product ideas. Reach me by email or use the form below to

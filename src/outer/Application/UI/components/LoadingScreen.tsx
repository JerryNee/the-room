        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            <p>Released: 06/29/2026</p>
                            <p>JNBIOS (C)2026 Jianwei Ni,</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>JNP S13 2026 Special UIUC131S</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>JNP Portfolio(tm) XX 113</p>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Jianwei Ni Portfolio Showcase</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
